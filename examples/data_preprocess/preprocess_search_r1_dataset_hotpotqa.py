    ...
    with tempfile.TemporaryDirectory() as tmp_download_dir:
        for split in ["train", "test"]:
            ...
            try:
                ...
                df_raw = load_dataset(args.hf_repo_id, split=split)
                # to dataframe
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hf_repo_id", default="Seungyoun/search_r1_hotpotqa_train_hard", help="HuggingFace dataset repository ID.")
    parser.add_argument("--local_dir", default="~/data/searchR1_hotpotqa_processed_direct", help="Local directory to save the processed Parquet files.")
